...
router.get('/javdb/search/:keyword?/:filter?/:page?', require('./routes/javdb/search'));
...
router.get('/javdb/video_codes/:keyword?/:filter?/:page?', require('./routes/javdb/video_codes'));
